    ...
    selectedTools: [
      { toolName: "hangUp" },
      {
        temporaryTool: {
          ...
          description:
            "Get the restaurant address and phone number. Call this when the customer asks where the restaurant is located, what the address is, or how to contact the restaurant.",
          http: {
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Get the restaurant opening hours. Call this when the customer asks about hours, what time you open or close, whether you are open on a specific day, or anything related to business hours.",
          http: {
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Transfer the live call to a human staff member. Use this if the customer asks to speak to a person or if you cannot help them. Tell the customer you are connecting them, then call this tool.",
          http: {
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Get the current saved cart from the server. Use this when the customer asks for a recap, when you need to confirm what is already in the order, and always right before the final checkout recap and sendCheckoutLink.",
          http: {
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Add an item to the cart or increase its quantity. Call this every time the customer confirms they want an item, after required modifiers are finalized. If the customer requests a customization that is not available as a modifier option, capture it in the note field instead.",
          dynamicParameters: [
            {
              name: "item",
              ...
              schema: {
                ...
                properties: {
                  ...
                  price_cents: {
                    type: "integer",
                    description: "Base price only, no modifiers",
                  },
                  note: {
                    type: "string",
                    description:
                      "Free-text special instructions (e.g., light sauce, no MSG). Use this when the customer requests a customization that is not available as a modifier option.",
                  },
                  modifiers: {
                    type: "array",
                    description:
                      "Modifier IDs selected by the customer. Use mod_id values from the menu.",
                    items: {
                      type: "object",
                      properties: {
                        mod_id: { type: "string" },
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Remove an item from the cart or reduce its quantity. Use the exact modifier IDs and note for the cart line you want to change.",
          dynamicParameters: [
            {
              name: "item",
              location: "PARAMETER_LOCATION_BODY",
              schema: {
                ...
                properties: {
                  ...
                  quantity: {
                    type: "integer",
                    description: "How many to remove from this exact cart line",
                  },
                  modifiers: {
                    type: "array",
                    description:
                      "The modifiers on the exact cart line to update. Use an empty array when there are no modifiers.",
                    items: {
                      type: "object",
                      properties: {
                        mod_id: { type: "string" },
                  ...
                  note: {
                    type: "string",
                    description:
                      "The note on the exact cart line to remove. Must match exactly.",
                  },
                },
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Clear the entire saved cart. Use this if a resumed caller wants to start over from scratch.",
          http: {
      ...
      },
      {
        temporaryTool: {
          ...
          description:
            "Save the customer first and last name after they spell it during checkout. Call this after you have both names and before you send the checkout link.",
          dynamicParameters: [
            {
              name: "firstName",
              location: "PARAMETER_LOCATION_BODY",
              schema: {
                type: "string",
                description:
                  "The customer first name exactly as confirmed on the call.",
              },
              required: true,
            },
            {
              ...
              schema: {
                type: "string",
                description:
                  "The customer last name exactly as confirmed on the call.",
              },
              required: true,
            },
          ],
    ...
    selectedTools: [
      ...
      },
      {
        temporaryTool: {
          modelToolName: "addToCart",
          description:
            "Add an item to the cart or increase its quantity. Call this every time the customer confirms they want an item.",
          dynamicParameters: [
            {
              name: "item",
              location: "PARAMETER_LOCATION_BODY",
              schema: {
                ...
                properties: {
                  ...
                  price_cents: {
                    type: "integer",
                    description: "Base price in cents, no modifiers",
                  },
                  modifiers: {
                    type: "array",
                    items: {
      ...
      },
      {
        temporaryTool: {
          modelToolName: "clearCart",
          description:
            "Clear the entire saved cart. Use this if a caller wants to start over from scratch.",
          http: {
            baseUrlPattern: `${serverUrl}/tool/cart/clear/${encodeURIComponent(callerPhone)}`,
            httpMethod: "POST",
          },
